    ...
    <div className={widthClass}>
      ...
      <div className="relative">
        <select
          ...
          onChange={onChange}
          className={twMerge(
            "block w-full cursor-pointer px-3 py-2 text-[#37352f] bg-notion-default border border-notion-border rounded-md focus:border-[#37352f] focus:ring-1 focus:ring-[#37352f] outline-none transition-colors",
